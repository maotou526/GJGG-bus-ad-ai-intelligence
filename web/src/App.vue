 ...
 * @LastEditors: 王晨
 * @LastEditTime: 2025-12-27 15:38:20
-->
<template>
...
.PageFeatureSearchMulti {
	.fs-search-layout-default.fs-search-multi-line .fs-search-box .fs-search-main.fs-search-collapse {
		max-height: 80px !important;
	}
}
// 搜索区域按钮组样式
.fs-search-layout-default .fs-search-buttons-group {
	// 在这里添加你需要的样式
	// 例如：
...
// 统一 input 和 textarea 的 placeholder 颜色（使用 textarea 的颜色）
