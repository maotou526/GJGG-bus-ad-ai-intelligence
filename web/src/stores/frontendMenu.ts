...
export const handleMenu = (menuData: Array<any>) => {
    ...
    const handleMeta = (item: any) => {
        ...
        if(item.is_catalog){
            ...
            // 检查是否为业务菜单，如果是则指向开发中页面
            const businessMenus = [
                'biz/customer/index', 'biz/personnel/index', 'biz/vehicle/index', 'biz/route/index',
                'biz/station/index', 'biz/depot/index', 'biz/warehouse/index',
                'biz/assetIn/index', 'biz/assetCode/index', 'biz/assetBundle/index',
                'biz/esignPassengerList/index', 'biz/esignPassengerRepair/index', 'biz/esignPassengerAlert/index',
                'biz/dispatchScreenInfo/index', 'biz/dispatchScreenRepair/index',
                'biz/vehicleDeviceInfo/index', 'biz/vehicleDeviceRepair/index', 'biz/vehicleDeviceAlert/index',
                'biz/passengerDeviceInfo/index', 'biz/passengerDeviceRepair/index', 'biz/passengerDeviceAlert/index'
            ];
            
            if (businessMenus.includes(item.component as string)) {
                // 业务菜单重定向到开发中页面
                item.component = dynamicImport(dynamicViewsModules, '/system/underDevelopment/index');
            } else {
                // 普通菜单正常加载
