<!--
 * @Description: 线路走向信息列表组件（用于详情弹窗）
 * @Version: 1.0
 * @Autor: 王晨
 * @Date: 2025-01-XX
-->
<template>
	<div class="roadline-detail-list">
...
import createCrudOptions from './roadlineDetailCrud';

export default defineComponent({
	name: 'RoadlineDetailList',
	setup(_, { expose }) {
		...
		const refresh = (roadlineId: number) => {
			...
			if (crudExpose) {
				// 设置搜索条件，过滤当前线路的数据
				crudExpose.setSearchFormData({ roadline: roadlineId });
