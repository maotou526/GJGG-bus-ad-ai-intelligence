...
<template>
    <fs-page class="PageFeatureSearchMulti">
        <fs-crud ref="crudRef" v-bind="crudBinding">
            ...
            <!--  功能说明:使用导入组件，并且修改api地址为当前对应的api，当前是district的api="api/DistrictModelViewSet/"-->
            <template #actionbar-right>
                <importExcel api="api/DistrictModelViewSet/" v-auth="'user:Import'">导入</importExcel>
            </template>
...
export default defineComponent({    //这里配置defineComponent
    name: "DistrictModelViewSet",   //把name放在这里进行配置了
