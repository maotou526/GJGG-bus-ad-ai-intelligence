    ...
    <fs-page class="PageFeatureSearchMulti">
        <fs-crud ref="crudRef" v-bind="crudBinding">
            <template #actionbar-right>
                <importExcel api="api/OsmNodeWayRelModelViewSet/" v-auth="'OsmNodeWayRelModelViewSet:Import'">导入</importExcel>
            </template>
        </fs-crud>
    </fs-page>
</template>
...
export default defineComponent({
    name: "OsmNodeWayRelModelViewSet",
